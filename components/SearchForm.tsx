...
const NICHE_GROUPS: Record<string, string[]> = {
  '🍎 Education — Early Childhood': ['Daycare center','Crèche','Nursery school','Preschool','Kindergarten','Montessori school','Early years learning center','Toddler playgroup','Baby and toddler class','Child development center'],
  '🏫 Education — Primary & Secondary': ['Primary school','Junior secondary school','Senior secondary school','Private school','International school','Faith-based school','Boarding school','Special needs school','STEM school','Girls school','Boys school','Mixed secondary school'],
  '📖 Education — Tutorial & Coaching': ['Tutorial center','After-school lessons','Home tutoring service','JAMB tutorial center','WAEC coaching center','IGCSE tutoring','A-Level tutoring','SAT/ACT prep center','Remedial classes','Academic coaching'],
  '🎓 Education — Vocational & Skills': ['Vocational training center','Skills acquisition center','Trade school','Coding bootcamp','IT training center','Culinary school','Fashion design school','Photography school','Film school','Makeup artistry school'],
  '🎵 Education — Arts & Enrichment': ['Music school','Dance studio','Drama school','Fine arts school','Sports academy','Swimming school','Chess academy','Language school','Driving school','Debate and public speaking academy'],
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-2">
              <input type="text" name="productNiche" value={formData.productNiche} onChange={handleChange} placeholder="e.g., daycare, primary school, tutorial center, event planning..." className="flex-1 border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" required />
          ...
          <div>
            ...
            <input type="text" name="jobTitle" value={formData.jobTitle} onChange={handleChange} placeholder="e.g., owner, founder, CEO, manager, principal" className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
        </div>
